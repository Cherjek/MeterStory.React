...
export const _groupsTypeMeter = [
  ...
  [
    ...
    ['Э\сч Пульсар, 1ф4т',37],['Э\сч Пульсар, 3ф4т',38]
  ],
  // 1 - концентраторы импульсных счетчиков
  [
    ['УМТВ10',9],['Сч. имп.-рег. Пульсар',93],['Концентратор МИЛУР IC',94]
  ],
...
export const _groupsTypeMeterDictionary = [
  ...
  { id: 1, name: 'Импульсные счетчики' },
  { id: 2, name: 'Радиоконцентраторы и радиоретрансляторы' },
  { id: 3, name: 'Модули дискретных вводов' }
];
